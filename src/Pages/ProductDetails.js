    ...
    return (
      <React.Fragment>
        <section id="aa-catg-head-banner">
          <img
            src="Content/img/fashion/fashion-header-bg-8.jpg"
            alt="fashion img"
          />
                          ...
                          >
                            <div className="simpleLens-container">
                              <div className="simpleLens-big-image-container">
                                <a
                                  data-lens-image={
                                    "Content/img/" +
                                    this.state.productDetails.imgurl
                                  }
                            ...
                            <div className="simpleLens-thumbnails-container">
                              ...
                              {this.state.productDetails.productImages ? (
                                this.state.productDetails.productImages.map(
                                  (p) => {
                                    return (
                                      <a
                                        key={p}
                        ...
                        <div className="aa-product-view-content">
                          ...
                          <div className="aa-price-block">
                            <span className="aa-product-view-price">
                              {this.state.productDetails.currency}
                              {this.state.productDetails.discountedprice}
                            </span>
                            <p className="aa-product-avilability">
                              Avilability:{" "}
                              <span>{this.state.productDetails.status}</span>
                            </p>
                          </div>
                          ...
                          <div className="aa-prod-view-size">
                            {this.state.productDetails.sizes ? (
                              this.state.productDetails.sizes.map((p) => {
                                return (
                                  <a href="javascript:void(0)" key={p}>
                                    {p}
                                  </a>
                                );
                              })
                          ...
                          <div className="aa-color-tag">
                            <a
                              href="javascript:void(0)"
                              className="aa-color-green"
                            ></a>
                            <a
                              href="javascript:void(0)"
                              className="aa-color-yellow"
                            ></a>
                            <a
                              href="javascript:void(0)"
                              className="aa-color-pink"
                            ></a>
                            <a
                              href="javascript:void(0)"
                              className="aa-color-black"
                            ></a>
                            <a
                              href="javascript:void(0)"
                              className="aa-color-white"
                            ></a>
                          </div>
                          <div className="aa-prod-quantity">
                            <SelectControl
                              ...
                              selectedOption={this.state.totalPiece}
                            />
                          ...
                          <div className="aa-prod-view-bottom">
                            <a
                              onClick={() =>
                                this.handleAddToCart(this.state.productDetails)
                              }
                            ...
                            <a
                              onClick={() =>
                                this.handleAddToWishList(
                                  ...
                                  this.state.productDetails.isWhishList
                                )
                              }
                              className="aa-add-to-cart-btn"
                              href="javascript:void(0)"
                              style={{
                                color: this.state.productDetails.isWhishList
                                  ? "#ff6666"
                                  : "#555",
                                border: this.state.productDetails.isWhishList
                                  ? "1px solid #ff6666"
                                  : "1px solid #ccc",
                              }}
                            >
