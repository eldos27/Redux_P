...
class Products extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (
      nextProps.location.state.productid !== this.props.location.state.productid
    ) {
    ...
    if (nextProps.sortOption !== this.props.sortOption) {
      let productCategoryId = nextProps.location.state.productid;
      this.props.reducerProducts(
        productCategoryId,
        nextProps.sortOption,
        "",
        ""
      );
    }
  ...
  render() {
    ...
    let totalcountingofItemsPerPage = Math.ceil(
      this.props.products.length / todosPerPage
    );
                    ...
                    <div className="aa-product-catg-content">
                      <div className="aa-product-catg-head">
                        ...
                        <div className="aa-product-catg-head-right">
                          <a id="grid-catg" href="javascript:void(0)">
                            <span className="fa fa-th"></span>
                          </a>
                          <a id="list-catg" href="javascript:void(0)">
                            ...
                            return (
                              <li key={p.id}>
                                ...
                                <div className="aa-product-hvr-content">
                                  <a
                                    onClick={() =>
                                      this.handleAddToWishList(p, p.isWhishList)
                                    }
                                    href="javascript:void(0)"
                                    data-toggle="tooltip"
                                    data-placement="top"
                            ...
                            {isPreviousAvail && (
                              <li key={0}>
                                <a
                                  type="prev"
                                  id={currentPage}
                                  onClick={this.onChangeNextPrevious.bind(this)}
                                  href="javascript:void(0)"
                                  aria-label="Previous"
                                >
                  ...
                  <div className="aa-sidebar-widget">
                    ...
                    <div className="aa-sidebar-price-range">
                      <form action="">
                        ...
                        <button
                          onClick={this.doPriceFilter.bind(this)}
                          className="aa-filter-btn"
                          type="button"
                        >
                          Filter
                        </button>
