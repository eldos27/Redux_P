...
import {
  ...
  fetchBlogs,
  fetchTestimonials,
} from "../Redux/Actions/StaticItems";
...
import {
  ...
  addToWishList,
  removeFromWishList,
} from "../Redux/Actions/CartProducts";
      ...
      <React.Fragment>
              ...
              <div className="col-md-12">
                <div className="row">
                  <div className="aa-banner-area">
                    <a href="javascript:void(0)">
                      <img
                        src="Content/img/fashion-banner.jpg"
                  ...
                  <div className="aa-popular-category-area">
                    ...
                    <div className="tab-content">
                      <div className="tab-pane fade in active" id="popular">
                        ...
                        <a className="aa-browse-btn" href="javascript:void(0)">
                          Browse all Product{" "}
                          <span className="fa fa-long-arrow-right"></span>
                        </a>
                      </div>
                            ...
                            <figure className="aa-blog-img">
                              ...
                              <figcaption className="aa-blog-img-caption">
                                <span href="javascript:void(0)">
                                  ...
                                  {new Date(p.createDate).toLocaleString(
                                    "en-US",
                                    {
                                      year: "numeric",
                                      month: "short",
                ...
                <div class="aa-client-brand-area">
                  <ul class="aa-client-brand-slider">
                    <li>
                      <a href="#">
                        <img
                          src="content/img/client-brand-java.png"
                          alt="java img"
                        />
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img
                          src="content/img/client-brand-jquery.png"
                          alt="jquery img"
                        />
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img
                          src="content/img/client-brand-html5.png"
                          alt="html5 img"
                        />
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img
                          src="content/img/client-brand-css3.png"
                          alt="css3 img"
                        />
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img
                          src="content/img/client-brand-wordpress.png"
                          alt="wordPress img"
                        />
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img
                          src="content/img/client-brand-joomla.png"
                          alt="joomla img"
                        />
                      </a>
                    </li>
        ...
        >
          <ModalPopup
            ...
            addToCart={() => this.handleAddToCart(this.state.productDetails)}
          />
        </Modal>
      </React.Fragment>
    );
